# experiments/exp_011_e2_k2_p1.py
from store.models import ProductSpec, RoundSpec, ListingEntry

EXPERIMENT = {
    "code": "RQ2_E2_k2_p1",
    "rq_id": 2,
    "name": "E2 (k=2, +1% Price Premium) — Low Price Shock",
    "description": (
        "Evaluates price resilience under a 1% premium after 2 discount rounds. "
        "Rounds 1-2 seed Nordvik with a 20% discount (12.0 vs 15.0). "
        "Round 3 tests choice when Nordvik is 1% more expensive (15.15 vs 15.0)."
    ),
    ...
    # ── Schedule: 2 Seeding Rounds + 1 Evaluation Round (+1% Shock) ──
    "schedule": [
        RoundSpec(
            budget=100.0,
            listings={
        ...
        # Round 3: +1% price premium shock (15.15 vs 15.0)
        RoundSpec(
            budget=100.0,
            listings={
