# experiments/exp_014_e2_k3_p3.py
from store.models import ProductSpec, RoundSpec, ListingEntry

EXPERIMENT = {
    "code": "RQ2_E2_k3_p3",
    "rq_id": 2,
    "name": "E2 (k=3, +3% Price Premium) — Low Price Shock",
    "description": (
        "Evaluates price resilience under a 3% premium after 3 discount rounds. "
        "Rounds 1-3 seed Nordvik with a 20% discount (12.0 vs 15.0). "
        "Round 4 tests choice when Nordvik is 3% more expensive (15.45 vs 15.0)."
    ),
    ...
    # ── Schedule: 3 Seeding Rounds + 1 Evaluation Round (+3% Shock) ──
    "schedule": [
        RoundSpec(
            budget=100.0,
            listings={
        ...
        # Round 4: +3% price premium shock (15.45 vs 15.0)
        RoundSpec(
            budget=100.0,
            listings={
