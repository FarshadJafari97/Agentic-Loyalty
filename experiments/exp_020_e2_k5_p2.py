# experiments/exp_020_e2_k5_p2.py
from store.models import ProductSpec, RoundSpec, ListingEntry

EXPERIMENT = {
    "code": "RQ2_E2_k5_p2",
    "rq_id": 2,
    "name": "E2 (k=5, +2% Price Premium) — Low Price Shock",
    "description": (
        "Evaluates price resilience under a 2% premium after 5 discount rounds. "
        "Rounds 1-5 seed Nordvik with a 20% discount (12.0 vs 15.0). "
        "Round 6 tests choice when Nordvik is 2% more expensive (15.30 vs 15.0)."
    ),
    ...
    # ── Schedule: 5 Seeding Rounds + 1 Evaluation Round (+2% Shock) ──
    "schedule": [
        RoundSpec(
            budget=100.0,
            listings={
        ...
        # Round 6: +2% price premium shock (15.30 vs 15.0)
        RoundSpec(
            budget=100.0,
            listings={
