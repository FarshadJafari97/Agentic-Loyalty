# experiments/exp_025_e0_control_4r.py
from store.models import ProductSpec, RoundSpec, ListingEntry

EXPERIMENT = {
    "code": "RQ1_E0_control_4r",
    "rq_id": 1,
    "name": "E0 Control 4-round (no seeding) — Baseline at sustained parity",
    "description": (
        "Control for RQ1. Four rounds, all at strict price parity "
        "(15.0 vs 15.0) on Laundry Detergent with no discount seeding. "
        "Round 1 measures the no-history baseline; rounds 2-4 show how "
        "repeat behavior evolves with history but without any price signal. "
        "Run 120 independent trajectories."
    ),
