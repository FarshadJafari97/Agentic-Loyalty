# experiments/exp_009_e2_k2_p3.py
from store.models import ProductSpec, RoundSpec, ListingEntry

EXPERIMENT = {
    "code": "RQ2_E2_k2_p3",
    "rq_id": 2,
    "name": "E2 (k=2, +3% Price Premium) — Low Price Shock",
    "description": (
        "Evaluates price resilience under a 3% premium after 2 discount rounds. "
        "Rounds 1-2 seed Nordvik with a 20% discount (12.0 vs 15.0). "
        "Round 3 tests choice when Nordvik is 3% more expensive (15.45 vs 15.0)."
    ),
    ...
    # ── Schedule: 2 Seeding Rounds + 1 Evaluation Round (+3% Shock) ──
    "schedule": [
        RoundSpec(
            budget=100.0,
            listings={
        ...
        # Round 3: +3% price premium shock (15.45 vs 15.0)
        RoundSpec(
            budget=100.0,
            listings={
