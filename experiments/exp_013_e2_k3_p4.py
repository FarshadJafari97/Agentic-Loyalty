# experiments/exp_013_e2_k3_p4.py
from store.models import ProductSpec, RoundSpec, ListingEntry

EXPERIMENT = {
    "code": "RQ2_E2_k3_p4",
    "rq_id": 2,
    "name": "E2 (k=3, +4% Price Premium) — Low Price Shock",
    "description": (
        "Evaluates price resilience under a 4% premium after 3 discount rounds. "
        "Rounds 1-3 seed Nordvik with a 20% discount (12.0 vs 15.0). "
        "Round 4 tests choice when Nordvik is 4% more expensive (15.60 vs 15.0)."
    ),
    ...
    # ── Schedule: 3 Seeding Rounds + 1 Evaluation Round (+4% Shock) ──
    "schedule": [
        RoundSpec(
            budget=100.0,
            listings={
        ...
        # Round 4: +4% price premium shock (15.60 vs 15.0)
        RoundSpec(
            budget=100.0,
            listings={
