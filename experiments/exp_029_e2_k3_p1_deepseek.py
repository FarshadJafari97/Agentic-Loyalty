# experiments/exp_029_e2_k3_p1_deepseek.py
from store.models import ProductSpec, RoundSpec, ListingEntry

EXPERIMENT = {
    "code": "RQ2_E2_k3_p1_deepseek",
    "rq_id": 2,
    "name": "E2 (k=3, +1%, deepseek-4.1-flash) — Low Price Shock",
    "description": (
        "Same design as RQ2_E2_k3_p1 but run with deepseek-4.1-flash. "
