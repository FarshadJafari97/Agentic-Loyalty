# experiments/exp_031_e3_k3_parity_deepseek.py
from store.models import ProductSpec, RoundSpec, ListingEntry

EXPERIMENT = {
    "code": "RQ3_E3_k3_parity_deepseek",
    "rq_id": 3,
    "name": "E3 (k=3, parity, deepseek-4.1-flash) — Brand Spillover at Equal Price",
    "description": (
        "Same design as RQ3_E3_k3_parity but run with deepseek-4.1-flash. "
