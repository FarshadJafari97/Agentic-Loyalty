# experiments/exp_030_e3_k3_parity_gemini.py
from store.models import ProductSpec, RoundSpec, ListingEntry

EXPERIMENT = {
    "code": "RQ3_E3_k3_parity_gemini",
    "rq_id": 3,
    "name": "E3 (k=3, parity, gemini-3.5-flash-lite) — Brand Spillover at Equal Price",
    "description": (
        "Same design as RQ3_E3_k3_parity but run with gemini-3.5-flash-lite. "
