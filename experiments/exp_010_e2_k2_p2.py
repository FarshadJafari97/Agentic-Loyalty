# experiments/exp_010_e2_k2_p2.py
from store.models import ProductSpec, RoundSpec, ListingEntry

EXPERIMENT = {
    "code": "RQ2_E2_k2_p2",
    "rq_id": 2,
    "name": "E2 (k=2, +2% Price Premium) — Low Price Shock",
    "description": (
        "Evaluates price resilience under a 2% premium after 2 discount rounds. "
        "Rounds 1-2 seed Nordvik with a 20% discount (12.0 vs 15.0). "
        "Round 3 tests choice when Nordvik is 2% more expensive (15.30 vs 15.0)."
    ),
    ...
    # ── Schedule: 2 Seeding Rounds + 1 Evaluation Round (+2% Shock) ──
    "schedule": [
        RoundSpec(
            budget=100.0,
            listings={
        ...
        # Round 3: +2% price premium shock (15.30 vs 15.0)
        RoundSpec(
            budget=100.0,
            listings={
