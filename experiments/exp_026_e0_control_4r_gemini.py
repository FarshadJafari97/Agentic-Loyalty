# experiments/exp_026_e0_control_4r_gemini.py
from store.models import ProductSpec, RoundSpec, ListingEntry

EXPERIMENT = {
    "code": "RQ1_E0_control_4r_gemini",
    "rq_id": 1,
    "name": "E0 Control 4-round (gemini-3.5-flash-lite) — Baseline at sustained parity",
    "description": (
        "Same design as RQ1_E0_control_4r but run with gemini-3.5-flash-lite. "
